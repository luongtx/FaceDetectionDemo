...
import com.example.facedetectiondemo.helper.GraphicOverlay;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFaceDetect = findViewById(R.id.btn_detect_face);
    ...
    private void getFaceResult(List<FirebaseVisionFace> firebaseVisionFaces) {
        System.out.println("MainActivity.getFaceResult");
        for (FirebaseVisionFace face: firebaseVisionFaces) {
            Rect rect = face.getBoundingBox();
            RectOverlay rectOverlay = new RectOverlay(graphicOverlay, rect);
            graphicOverlay.add(rectOverlay);
            System.out.println("--------------------");
            System.out.println("angle y: "+face.getHeadEulerAngleY());
            System.out.println("angle z: "+face.getHeadEulerAngleZ());
        }
        alertDialog.dismiss();
    }
